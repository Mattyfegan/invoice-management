...
const customStyles: StylesConfig = {
    ...
    option: (provided, state) => ({
      ...
      fontSize: '15px',
      padding: '2px',
      backgroundColor: state.isSelected ? '#9389AE' : 'transparent',
      '&:hover': {
...
const CountryDropdown: React.FC = () => {
  const handleCountryChange = (selectedOption: ValueType<CountryOption>) => {
    if (selectedOption) {
      const countryValue = (selectedOption as CountryOption).value;
      console.log(countryValue); // Access the selected country value
    }
  };

  return (
    <Select<CountryOption> className="countrySelect" options={countryOptions} onChange={handleCountryChange} styles={customStyles}/>
  );
};
